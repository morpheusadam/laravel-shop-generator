<div class="row">
    <div class="col-md-8">
        ...
        {{ Form::text('translatable[razorpay_label]', trans('setting::attributes.translatable.razorpay_label'), $errors, $settings, ['required' => true]) }}
        {{ Form::textarea('translatable[razorpay_description]', trans('setting::attributes.translatable.razorpay_description'), $errors, $settings, ['rows' => 3, 'required' => true]) }}

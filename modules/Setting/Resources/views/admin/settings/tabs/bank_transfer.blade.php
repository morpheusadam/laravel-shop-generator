<div class="row">
    <div class="col-md-8">
        ...
        <div class="{{ old('bank_transfer_enabled', array_get($settings, 'bank_transfer_enabled')) ? '' : 'hide' }}" id="bank-transfer-fields">
            {{ Form::textarea('translatable[bank_transfer_instructions]', trans('setting::attributes.translatable.bank_transfer_instructions'), $errors, $settings, ['rows' => 3, 'required' => true,'placeholder'=>'Bank details & instructions to transfer&#10;(HTML tags supported)']) }}
        </div>
    </div>
</div>

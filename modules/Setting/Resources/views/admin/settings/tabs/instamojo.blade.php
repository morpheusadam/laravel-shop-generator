<div class="row">
    <div class="col-md-8">
        ...
        {{ Form::text('translatable[instamojo_label]', trans('setting::attributes.translatable.instamojo_label'), $errors, $settings, ['required' => true]) }}
        {{ Form::textarea('translatable[instamojo_description]', trans('setting::attributes.translatable.instamojo_description'), $errors, $settings, ['rows' => 3, 'required' => true]) }}

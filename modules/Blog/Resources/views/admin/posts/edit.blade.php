...
@component('admin::components.page.header')
    @slot('title', trans('admin::resource.edit', ['resource' => trans('blog::admin.blog_post.name')]))
    @slot('subtitle', $blogPost->title)

    <li><a href="{{ route('admin.blog_posts.index') }}">{{ trans('blog::admin.blog_posts.name') }}</a></li>
    <li class="active">{{ trans('admin::resource.edit', ['resource' => trans('blog::admin.blog_post.name')]) }}</li>
@endcomponent
...
@push('globals')
    @vite([
        ...
        'modules/Blog/Resources/assets/admin/posts/js/edit.js',
